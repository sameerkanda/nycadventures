<?php
include __DIR__.'/parseConfig.php';
include __DIR__.'/parseObject.php';
include __DIR__.'/parseQuery.php';
include __DIR__.'/parseUser.php';
include __DIR__.'/parseFile.php';
include __DIR__.'/parsePush.php';
include __DIR__.'/parseGeoPoint.php';
include __DIR__.'/parseACL.php';
include __DIR__.'/parseCloud.php';
